...
public class WriterVisitor implements Visitor {
  ...
  public Object visitProgram(Program ast, Object obj) {
    ...
    if(ast instanceof SingleProgram){
        SingleProgram newAST=(SingleProgram)ast;
        newAST.getC().visit(this, null);
    }else{
        CompoundProgram newAST=(CompoundProgram)ast;
        newAST.getC() .visit(this, null);
        newAST.getD() .visit(this, null);
    }
    writeLineHTML("</Program>");
    return null;
  }
  ...
  private String transformOperator(String operator) {
    ...
    public Object visitProcFuncFuncDeclaration(ProcFuncFuncDeclaration ast, Object o) {
        writeLineHTML("<ProcFuncFuncDeclaration>");
        ast.I.visit(this, null);
        ast.FPS.visit(this, null);
        ast.T.visit(this, null);
        ast.E.visit(this, null);
    ...
    public Object visitProcFuncProcDeclaration(ProcFuncProcDeclaration ast, Object o) {
        writeLineHTML("<ProcFuncProcDeclaration>");
        ast.I.visit(this, null);
        ast.FPS.visit(this, null);
        ast.C.visit(this, null);
        writeLineHTML("</ProcFuncProcDeclaration>");
    ...
    public Object visitCompoundLongIdentifier(CompoundLongIdentifier ast, Object o) {
        writeLineHTML("<CompoundLongIdentifier>");
        ast.getPackageIdentifier().visit(this, null);
        ast.getIdentifier().visit(this, null);
        writeLineHTML("</CompoundLongIdentifier>");
        return null;
    }
    ...
    public Object visitRecursiveCompound_Declaration(RecursiveCompound_Declaration aThis, Object o) {
        writeLineHTML("<RecursiveCompound_Declaration>");
    ...
    public Object visitPrivateCompound_Declaration(PrivateCompound_Declaration aThis, Object o) {
        writeLineHTML("<PrivateCompound_Declaration>");
        aThis.D1.visit(this, null);
    ...
    public Object visitSequentialProcFuncDeclaration(SequentialProcFuncDeclaration aThis, Object o) {
        writeLineHTML("<SequentialProcFuncDeclaration>");
        aThis.D1.visit(this, null);
        aThis.D2.visit(this, null);
        writeLineHTML("</SequentialProcFuncDeclaration>");
        return null;
